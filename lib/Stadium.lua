...
function Stadium.mode()
  ...
  -- Gold's dedicated in-world battle option always selects the MAP/Stadium
  -- rung. Individual species still fall back to their normal battle pic when
  -- their Stadium pack cannot be built.
  if V.game and V.game.world and OverworldBattle.enabled() then return "A" end
...
function Stadium.update(dt, battle, groundY)
  ...
  for _, side in ipairs({ "enemy", "player" }) do
    ...
    mon:setSpecies(dex, V.game and V.game.world ~= nil)
